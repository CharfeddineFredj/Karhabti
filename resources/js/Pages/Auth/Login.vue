...
<app-layout>
	<div class="max-w-7xl mx-auto p-6 my-12">
    ...
    <div class="w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        ...
        <form  @submit.prevent="submit" class="mt-6">
            ...
            <div class="mt-4">
                ...
                <!--inertia-link v-if="canResetPassword" :href="route('password.request')" class="text-xs text-gray-600 dark:text-gray-400 hover:underline">
        ...
        <div class="flex items-center mt-6 space-x-3">
            ...
            <a href="#"
                class="p-2 text-sm font-medium text-gray-500 transition-colors duration-200 transform bg-gray-300 rounded-md hover:bg-gray-200">
        ...
        <p class="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? 
            <a :href="route('register')" class="font-medium text-gray-800 dark:text-gray-200 hover:underline">Create One</a></p>
    </div>
    </div>
